...
static const ProtobufCFieldDescriptor auth_reply_msg__field_descriptors[23] =
{
  {
    "reply",
    1,
...
static const ProtobufCFieldDescriptor cookie__field_descriptors[9] =
{
  {
    "username",
    1,
